...
public class DeptoServiceTests
{
    ...
    {
        // Arrange
        var existingDepto = new Depto(new Edificio("Edificio1", "Direccion1", "Ubicacion", new Constructora ("Constructora"), 100, new List<Depto>()), 5, 101, null, 3, 2, false);
    ...
    {
        // Arrange
        var newDepto = new Depto(new Edificio("Edificio1", "Direccion1", "Ubicacion", new Constructora ("Constructora"), 100, new List<Depto>()), 5, 101, null, 3, 2, false);
